...
variable "flow_log_max_aggregation_interval" {
  description = "Maximum interval for flow log aggregation"
  type        = number
  default     = 600
}

variable "enable_ec2_endpoint" {
  description = "Should be true if you want to provision an EC2 endpoint"
  type        = bool
  default     = false
}

variable "ec2_endpoint_private_dns_enabled" {
  description = "Whether or not to associate a private hosted zone with the VPC EC2 endpoint"
  type        = bool
  default     = true
}
