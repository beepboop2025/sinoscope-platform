import { memo, useState, useEffect, useRef, type ReactElement } from 'react';
...
interface PanelNetworkProps {
  pairs?: CorrelationPair[];
  symbols?: string[];
}

const PanelNetwork = memo(({ pairs = [], symbols = [] }: PanelNetworkProps): ReactElement => {
