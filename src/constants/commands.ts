...
export const COMMANDS: readonly CommandEntry[] = [
  ...
  { id: 'add_fundamentals', label: 'Add Fundamentals', desc: 'Add company fundamentals panel', action: 'addPanel', target: 'fundamentals' },
  { id: 'add_newsFeed', label: 'Add News Feed', desc: 'Add enhanced news feed', action: 'addPanel', target: 'newsFeed' },
  { id: 'add_econCalendar', label: 'Add Economic Calendar', desc: 'Add economic events calendar', action: 'addPanel', target: 'econCalendar' },
  { id: 'add_screener', label: 'Add Screener', desc: 'Add asset screener', action: 'addPanel', target: 'screener' },
  { id: 'add_heatMap', label: 'Add Heat Map', desc: 'Add market treemap heat map', action: 'addPanel', target: 'heatMap' },
  { id: 'add_orderBook', label: 'Add Order Book', desc: 'Add order book depth', action: 'addPanel', target: 'orderBook' },
