...
const ClockDisplay = memo<ClockDisplayProps>(({ label, tz }) => {
  const [time, setTime] = useState<string>(getTimeInZone(tz));
  useEffect(() => {
...
export default function Header({ wsStatus, onOpenCommandBar }: HeaderProps): React.JSX.Element {
