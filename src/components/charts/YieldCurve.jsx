...
const YieldCurve = memo(({ data = [], height = 200, prevData }) => {
  ...
  return (
    <ResponsiveContainer width="100%" height={height}>
      <LineChart data={data} margin={{ top: 8, right: 12, bottom: 4, left: 0 }}>
        ...
        <YAxis tick={{ fontSize: 9, fill: 'var(--text-4)' }} tickLine={false} axisLine={false} tickFormatter={v => `${v}%`} width={40} domain={['auto', 'auto']} />
        <Tooltip
